...
print(f"Background images generator initialized.")
        ...
        while True:
            try:
                ...
                image_file_path = os.path.join(
                    dataset_base_dir, image_file_name)
                label_file_path = os.path.join(
                    dataset_base_dir, label_file_name)
                ...
                traceback.print_exc()
                add_exclusion(
                    font, f"other: {repr(e)}", dataset_base_dir, i, j)
                return
